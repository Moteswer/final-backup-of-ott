...
from .views import MovieListView, Moviedetail, ProfileDetailView,kidprofile_details, home_view, kid_profile_registration_view, list_profiles, profile_details, profile_registration_view, register_customer,login_view
